...
class RetrieveData {
    ...
    private List<Map<String,String>> file2 = new ArrayList<Map<String, String>>();
        ...
        try
        {
            ...
            else if(table.equals("archived_documents"))
            {
                query = "SELECT archived_documents.id, archived_documents.folder_id, archived_documents.type, " +
                        ...
                        "archived_documents.upload_date, archived_documents.reference_no, archived_documents.academic_year FROM " + table +
                ...
                else
                {
                    ...
                    for(int i = 0; i < jsonArray.length(); i++)
                    {
                        ...
                        fileMap.put("refNum", filePojo.getReferenceNum());
                        fileMap.put("refNum1", filePojo.getReferenceNum());
                        fileMap.put("refNum2", filePojo.getReferenceNum());
                        fileMap.put("refNum3", filePojo.getReferenceNum());
                        file.add(fileMap);
                    }
                }
            }
        ...
        try
        {
            ...
            else if(table.equals("archived_documents"))
            {
                query = "SELECT archived_documents.id, archived_documents.folder_id, archived_documents.type, " +
                        "archived_documents.source_recipient, archived_documents.title, archived_documents.category, " +
                        "archived_documents.file_name, archived_documents.uploaded_by, archived_documents.email, " +
                        "archived_documents.upload_date, archived_documents.reference_no, archived_documents.academic_year FROM " + table + " INNER JOIN archived_folder " +
