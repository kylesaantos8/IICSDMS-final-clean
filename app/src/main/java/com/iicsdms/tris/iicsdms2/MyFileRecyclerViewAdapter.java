        ...
        public void onClick(View v){
            ...
            if(file.getType().equals("Incoming"))
            {
                ...
                else
                {
                    ...
                    args.putString("FilePojoStatus",file.getStatus());
                    args.putString("FilePojoSourceRecipient", file.getSourceRecipient());
                    args.putString("FilePojoReferenceNumber", file.getReferenceNum());
