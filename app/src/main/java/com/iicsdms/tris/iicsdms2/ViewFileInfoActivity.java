...
public class ViewFileInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                if(fileNotifId == null)
                {
                    if(filestatus.contains(getString(R.string.forward_from)))
                    {
                        ...
                        else if(notif[1].equals("IICS"))
                        {
                            ...
                            for(int i = 0; i < file.size(); i++)
                            {
                                notifSentence = file.get(i).get("notifEmail") + " " + getString(R.string.notif_inc_forward) + " " + title;
                                id = retrieveData.notifyId(notifyIdLink, notifSentence);
                    ...
                    {
                        notifSentence = filecreatedBy + " " + getString(R.string.notif_done) + " " + title;
                        id = retrieveData.notifyId(notifyIdLink, notifSentence);
        ...
        else if(filetype.equals("Personal"))
        {
            fileRefNoUploadBy.setText("Upload by");
            fileReferenceNo.setText("");
            fileFromTo.setText("Description");
            fileSrcRecipient.setText(filedesc);
            fileDescStatus.setText("");
            fileDesc.setText("");
        ...
        else if(filetype.equals("Archived"))
        {
            if(fileType.getText().toString().contains("Incoming")){
                fileRefNoUploadBy.setText("Reference Number");
                fileReferenceNo.setText(fileref);
                fileFromTo.setText("From");
                fileDescStatus.setText("Status");
                ...
                fileStatus.setText("");
                fileActionRequiredHolder.setText("");
                fileActionRequired.setText("");
                fileActionDueHolder.setText("");
                fileActionDue.setText("");
                notifStatus.setText("");
                notifStatusHolder.setText("");


            }
            else if(fileType.getText().toString().contains("Outgoing"))
            {
                fileRefNoUploadBy.setText("Upload by");
                fileFromTo.setText("To");
                fileDescStatus.setText("Description");
            ...
            else if(fileType.getText().toString().contains("Personal"))
            {
                fileRefNoUploadBy.setText("Upload by");
                fileFromTo.setText("Description");
                fileSrcRecipient.setText(filedesc);
